  ...
  return (
    <SettingsLayout>
      <div className="max-w-2xl">
        ...
        {/* Active Sessions */}
        <div className="bg-white border border-neutral-200 rounded-lg p-8 mb-6">
          <h2 className="text-lg font-bold text-black mb-4">Active Sessions</h2>
          <div className="space-y-3">
            <div className="border border-neutral-200 rounded-lg p-4 flex items-start justify-between">
              <div>
                <p className="font-medium text-black">Chrome on Windows</p>
                <p className="text-sm text-neutral-600">Last active: Just now</p>
              </div>
          ...
          <button
            ...
            disabled={isSaving}
            className="w-full mt-4 px-4 py-2 border border-neutral-300 text-black rounded-lg font-medium hover:bg-neutral-50 transition-colors disabled:opacity-50"
          >
